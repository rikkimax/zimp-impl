...
class GameStateTestSerialize(unittest.TestCase):
    ...
    def test_basic(self):
        ...
        """
        self.assertFalse(os.path.exists(TEST_TMP_DIR + sys._getframe().f_code.co_name + ".dat"))
        self.game_state.serialize(TEST_TMP_DIR + sys._getframe().f_code.co_name)
        self.assertTrue(os.path.exists(TEST_TMP_DIR + sys._getframe().f_code.co_name + ".dat"))
    ...
    def test_basic_object_property(self):
        ...
        """
        self.game_state.item1 = item.Item()
